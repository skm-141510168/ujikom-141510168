...
<body>
    ...
    <div id="wrapper" class="column">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <p><center> Menu <i class="glyphicon glyphicon-apple""></i></center></p>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-male"></i> Golongan<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/golongan')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a href="{{url('/golongan/create')}}"  class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/jabatan')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a href="{{url('/jabatan/create')}}"  class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/kategorilembur')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a  href="{{url('/kategorilembur/create')}}" class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/pegawai')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a href="{{url('/pegawai/create')}}" class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/lemburpegawai')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a href="{{url('/lemburpegawai/create')}}" class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/tunjangan')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a href="{{url('/tunjangan/create')}}" class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/tunjanganpegawai')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a href="{{url('/tunjanganpegawai/create')}}" class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('/penggajian')}}" class="glyphicon glyphicon-th-large">Table</a>
                                </li>
                                <li>
                                    <a href="{{url('/penggajian/create')}}" class="glyphicon glyphicon-pencil">Create</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row" >
                <div class="col-lg-12">
                    <i><h2 class="page-header" align="center">PENGGAJIAN KARYAWAN</h2></i>
                </div>
                @yield('content')
            </div>
